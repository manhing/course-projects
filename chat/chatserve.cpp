 ...
 *
 * ***********************************************************************************************
 * Most of the code and the comments related to connecting, sending, receiving, and forking
...
int main(int argc, char *argv[])
{
	...
	while(1)
	{
		...
		if (!fork()) { // this is the child process
			...
			//inner loop that takes turns receiving and sending messages
			while(1)
			{
				...
				//if user types in "\quit", exit program/process
